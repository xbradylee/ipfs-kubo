...
Before opening an issue, consider using one of the following locations to ensure you are opening your thread in the right place:
  - kubo (previously named go-ipfs) _implementation_ bugs in [this repo](https://github.com/xbradylee/ipfs-kubo/issues).
...
[Milestones on GitHub](https://github.com/xbradylee/ipfs-kubo/milestones)
...
- this project's GitHub [releases](https://github.com/xbradylee/ipfs-kubo/releases/latest) page
...
No longer supported, see rationale in [kubo#8688](https://github.com/xbradylee/ipfs-kubo/issues/8688).
...
No longer supported, see rationale in [kubo#9341](https://github.com/xbradylee/ipfs-kubo/issues/9341).
...
- See the [misc folder](https://github.com/xbradylee/ipfs-kubo/tree/master/misc) for how to connect IPFS to systemd or whatever init system your distro uses.
...
If you believe you've found a bug, check the [issues list](https://github.com/xbradylee/ipfs-kubo/issues) and, if you don't see your problem there, either come talk to us on [Matrix chat](https://docs.ipfs.tech/community/chat/), or file an issue of your own!
...
- Main file: [./cmd/ipfs/main.go](https://github.com/xbradylee/ipfs-kubo/blob/master/cmd/ipfs/main.go)
- CLI Commands: [./core/commands/](https://github.com/xbradylee/ipfs-kubo/tree/master/core/commands)
- Bitswap (the data trading engine): [go-bitswap](https://github.com/ipfs/go-bitswap)
- libp2p
  - libp2p: https://github.com/libp2p/go-libp2p
  - DHT: https://github.com/libp2p/go-libp2p-kad-dht
  - PubSub: https://github.com/libp2p/go-libp2p-pubsub
- [IPFS : The `Add` command demystified](https://github.com/xbradylee/ipfs-kubo/tree/master/docs/add-code-flow.md)
...
- Apache License, Version 2.0, ([LICENSE-APACHE](https://github.com/xbradylee/ipfs-kubo/blob/master/LICENSE-APACHE) or http://www.apache.org/licenses/LICENSE-2.0)
- MIT license ([LICENSE-MIT](https://github.com/xbradylee/ipfs-kubo/blob/master/LICENSE-MIT) or http://opensource.org/licenses/MIT)
