...
import (
	...
	dir "github.com/xbradylee/ipfs-kubo/thirdparty/dir"
	...
	serialize "github.com/xbradylee/ipfs-kubo/config/serialize"
...
func (r *FSRepo) openDatastore() error {
	...
	if r.config.Datastore.NoSync {
		log.Warn("NoSync is now deprecated in favor of datastore specific settings. If you want to disable fsync on flatfs set 'sync' to false. See https://github.com/xbradylee/ipfs-kubo/blob/master/docs/datastores.md#flatfs.")
	}
...
// https://github.com/xbradylee/ipfs-kubo/issues/8088 for more details).
